...
Uses the application's database configuration from app.core.config.
"""
...
def run_migrations_offline() -> None:
    ...
    """
    # Get URL from attributes first, fallback to config
...
def run_migrations_online() -> None:
    ...
    # Get from attributes first (set above), then from config
